...
def plot_Uz_velocity_profiles(paths, labels, z_array):
    plt.figure()
...
def plot_Ur_velocity_profiles(pathsUz, pathsUr, labels, z_array):
    plt.figure()
...
paths_Uz = [f"cleanData/Uz_l_{z}-m.csv" for z in [5, 7, 9, 11, 13, 15]]

paths_Ur = [f"cleanData/Ur_l_{z}-m.csv" for z in [5, 7, 9, 11, 13, 15]]

labels = [f" z= {z}" for z in [5, 7, 9, 11, 13, 15]]
z = [5, 7, 9, 11, 13, 15]

plot_Uz_velocity_profiles(paths_Uz, labels, z)


plot_Ur_velocity_profiles(paths_Uz, paths_Ur, labels, z)
